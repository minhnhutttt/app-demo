<template>
    <ContentWrap>
        <Content>
            <ContentTitle>About stake pools, operators, and owners</ContentTitle>
            <div class="main">
            ...
            <ContentPosts prev-title="Using the command line interface" prev-link="/getting-started/use-cli" />
        </Content>
        <ContentAnchor>
            <li><a
